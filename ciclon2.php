  ...
  <head>
	...
	<script type="text/javascript">
		...
		$(document).ready( function() { 
			setTimeout( function() { 
        //$('#some_id').load('ciclon3.php'); 
			window.location.href = "ciclon3.php";
		}, 2000); 
		}); 
	</script> 
      ...
      <div class="ed-container">
        ...
        <article class="ed-item base-100 tablet-100 web-50 hd-50 full-50">
          <div class="ed-item base-100 web-100">
            <div class="ciclon" ><img src="img/gift-card.png" alt=""  data-wow-duration="0.15s" style="visibility: visible; animation-delay: 1s; animation-duration: 2s; animation-iteration-count: 5;"  class="wow shake"/>
